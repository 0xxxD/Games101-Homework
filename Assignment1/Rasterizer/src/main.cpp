                                      ...
                                      float zNear, float zFar)
{
    ...
    Eigen::Matrix4f pOScale2I; // orthographic scale to [-1,1]^3 spatial area
    pOScale2I << 2 / (right - left), 0, 0, 0,
        0, 2 / (top - bottom), 0, 0,
        0, 0, 2 / (zNear - zFar), 0,
        0, 0, 0, 1;

    Eigen::Matrix4f pMove2ZeroPoint; // move to zero
    pMove2ZeroPoint << 0, 0, 0, -(right + left) / 2,
        0, 0, 0, -(top + bottom) / 2,
        0, 0, 0, -(zNear + zFar) / 2,
        0, 0, 0, 0;
